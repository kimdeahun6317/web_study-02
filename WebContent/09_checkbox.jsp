...
<head>
<meta charset="UTF-8">
<title>체크박스 결과 and select</title>
</head>
<body>
	<h2>고르신 악세사리는 ${item}입니다.</h2>
	
	<hr>
	<form action="SelectServlet" method="get">
	<span style="float: left;margin-rigth: 20px">
	...
	<br><br>
	<input type="submit" value="전송" style="float:rigth;margin-right:50px">
	</form>
</body>
</html>